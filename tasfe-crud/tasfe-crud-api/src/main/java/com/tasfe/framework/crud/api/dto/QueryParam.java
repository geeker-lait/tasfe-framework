...
public class QueryParam {
    ...
    public <T> QueryParam(CrudMethod cm, List<T> records) {
        this.crudMethod = cm.toString();
        this.entityList = records;
    }

    public <T> QueryParam(CrudMethod cm, T record) {
        this.crudMethod = cm.toString();
        this.entity = record;
    }

    public <T> QueryParam(CrudMethod cm, Class<T> entiyClass, Long id) {
        this.crudMethod = cm.toString();
        this.queryClazz = entiyClass;
        this.pk = id;
    }

    public <T> QueryParam(CrudMethod cm, Class<T> entiyClass, Long[] ids) {
        this.crudMethod = cm.toString();
        this.queryClazz = entiyClass;
        this.pks = ids;
    }
