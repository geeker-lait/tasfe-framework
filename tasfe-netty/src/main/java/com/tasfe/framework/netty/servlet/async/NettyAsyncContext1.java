package com.tasfe.framework.netty.servlet.async;
 ...
 */
public class NettyAsyncContext1 implements AsyncContext {

    final Logger logger = LoggerFactory.getLogger(NettyAsyncContext1.class);
    private ServletRequest servletRequest;
    private ServletResponse servletResponse;
    private long timeout;
    private List<AsyncListener> asyncListeners;

    public NettyAsyncContext1(ServletRequest servletRequest, ServletResponse servletResponse) {
