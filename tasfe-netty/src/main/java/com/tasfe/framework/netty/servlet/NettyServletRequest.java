...
import com.tasfe.framework.netty.servlet.async.NettyAsyncContext1;
...
public class NettyServletRequest implements HttpServletRequest {
    ...
    private NettyServletInputStream servletInputStream;
    private BufferedReader reader;
    private Map<String, List<Object>> header;
    private AsyncContext asyncContext;
    private String characterEncoding = "utf-8";

    public NettyServletRequest(String uri, WebContext webContext, String method, byte[] contentArray, String contentType,
    ...
    public AsyncContext startAsync(ServletRequest servletRequest, ServletResponse servletResponse)
        ...
        if (asyncContext == null) {
            asyncContext = new NettyAsyncContext1(servletRequest, servletResponse);
        }
        return asyncContext;
    }
